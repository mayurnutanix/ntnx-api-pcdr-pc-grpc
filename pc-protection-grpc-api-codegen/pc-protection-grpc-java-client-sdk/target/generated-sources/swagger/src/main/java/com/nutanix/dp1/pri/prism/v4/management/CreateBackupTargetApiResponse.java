...
/**
 * REST response for all response codes in API path /prism/v4.0/management/domain-managers/{domainManagerExtId}/backup-targets-new Post operation
 */

@Data
@lombok.extern.slf4j.Slf4j
public class CreateBackupTargetApiResponse implements java.io.Serializable, PriObjectTypeTypedObject {

  

  public CreateBackupTargetApiResponse() {
  ...
  @lombok.Builder(builderMethodName = "CreateBackupTargetApiResponseBuilder")
  public CreateBackupTargetApiResponse(com.nutanix.dp1.pri.common.v1.response.ApiResponseMetadata metadata, Object data) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
