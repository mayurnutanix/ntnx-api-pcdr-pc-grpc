  ...
  private void setUndeserializedFields(String name, String value) {
    ...
    public static class OneOfErrorWrapper {
      ...
      public OneOfErrorWrapper(java.util.List data) {
        ...
        if(com.nutanix.dp1.pri.prism.v4.error.AppMessage.class.equals(cls)) {
          this.oneOfType201 = (java.util.List<com.nutanix.dp1.pri.prism.v4.error.AppMessage>) data;
      ...
      public OneOfErrorWrapper(com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError data) {
      ...
      private static class OneOfErrorWrapperJsonDeserializer extends com.nutanix.dp1.pri.deserializers.PriOneOfDeserializer<OneOfErrorWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE201 = TYPE_FACTORY.constructCollectionType(java.util.List.class, com.nutanix.dp1.pri.prism.v4.error.AppMessage.class);
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE202 = TYPE_FACTORY.constructType(com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError.class);
      ...
      private java.util.List<com.nutanix.dp1.pri.prism.v4.error.AppMessage> oneOfType201;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      private com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError oneOfType202;
      ...
      public void setValue(Object value) {
        ...
        if (value instanceof com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError) {
          this.oneOfType202 = (com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError) value;
      ...
      private boolean setOneOfType201(Object value) {
        Class valueClass = com.nutanix.dp1.pri.prism.v4.error.AppMessage.class;
        if(java.util.List.class.isAssignableFrom(value.getClass())) {
          ...
          if (((java.util.List) value).size() > 0) { 
            if (valueClass.equals(((java.util.List) value).get(0).getClass())) {
              this.discriminator = "List<prism.v4.error.AppMessage>";
              this.$objectType = "List<prism.v4.error.AppMessage>";
              this.oneOfType201 = (java.util.List<com.nutanix.dp1.pri.prism.v4.error.AppMessage>) value;
              return true;
            }
            return false;
          } else {
            this.discriminator = "EMPTY_LIST";
            this.$objectType = "EMPTY_LIST";
            this.oneOfType201 = (List<com.nutanix.dp1.pri.prism.v4.error.AppMessage>) value;
            return true;
          }
        }
        return false;
     ...
     * <li>com.nutanix.dp1.pri.prism.v4.error.SchemaValidationError</li>
     * </ul>
     * @return Object
     */
