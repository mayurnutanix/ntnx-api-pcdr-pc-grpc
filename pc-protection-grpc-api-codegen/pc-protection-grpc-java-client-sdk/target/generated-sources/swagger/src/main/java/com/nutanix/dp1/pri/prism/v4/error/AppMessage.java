...
public class AppMessage implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public AppMessage(String message, com.nutanix.dp1.pri.common.v1.config.MessageSeverity severity, String code, String locale, String errorGroup, java.util.Map<String, String> argumentsMap) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
