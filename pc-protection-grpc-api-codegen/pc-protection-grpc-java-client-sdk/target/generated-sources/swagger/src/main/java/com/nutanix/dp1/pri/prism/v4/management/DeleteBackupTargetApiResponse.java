...
/**
 * REST response for all response codes in API path /prism/v4.0/management/domain-managers/{domainManagerExtId}/backup-targets-new/{extId} Delete operation
 */

@Data
@lombok.extern.slf4j.Slf4j
public class DeleteBackupTargetApiResponse implements java.io.Serializable, PriObjectTypeTypedObject {

  

  public DeleteBackupTargetApiResponse() {
  ...
  @lombok.Builder(builderMethodName = "DeleteBackupTargetApiResponseBuilder")
  public DeleteBackupTargetApiResponse(com.nutanix.dp1.pri.common.v1.response.ApiResponseMetadata metadata, Object data) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
  ...
  private void setUndeserializedFields(String name, Object value) {
    ...
    */
    ...
    public static class OneOfDataWrapper {
      ...
      public OneOfDataWrapper(com.nutanix.dp1.pri.prism.v4.config.TaskReference data) {
      ...
      private static class OneOfDataWrapperJsonDeserializer extends com.nutanix.dp1.pri.deserializers.PriOneOfDeserializer<OneOfDataWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE31007 = TYPE_FACTORY.constructType(com.nutanix.dp1.pri.prism.v4.config.TaskReference.class);
      ...
      private com.nutanix.dp1.pri.prism.v4.config.TaskReference oneOfType31007;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      ...
      public void setValue(Object value) {
        ...
        if (value instanceof com.nutanix.dp1.pri.prism.v4.config.TaskReference) {
          this.oneOfType31007 = (com.nutanix.dp1.pri.prism.v4.config.TaskReference) value;
     ...
     * <ul>
     * <li>com.nutanix.dp1.pri.prism.v4.config.TaskReference</li>
