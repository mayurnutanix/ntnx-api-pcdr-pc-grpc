...
public class BackupTarget extends com.nutanix.dp1.pri.common.v1.response.ExternalizableAbstractModel implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public BackupTarget(String tenantId, String extId, java.util.List<com.nutanix.dp1.pri.common.v1.response.ApiLink> links, Object location, java.time.OffsetDateTime lastSyncTime, Boolean isBackupPaused, String backupPauseReason) {
...
configuration data to the backup target. This field is updated every 30 minutes.
    ...
    public static class OneOfLocationWrapper {
      ...
      public OneOfLocationWrapper(com.nutanix.dp1.pri.prism.v4.management.ClusterLocation data) {
        this.oneOfType12001 = data;
        this.discriminator = data.get$objectType();
        this.$objectType = data.get$objectType();
      }
      public OneOfLocationWrapper(com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation data) {
      ...
      private static class OneOfLocationWrapperJsonDeserializer extends com.nutanix.dp1.pri.deserializers.PriOneOfDeserializer<OneOfLocationWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE12001 = TYPE_FACTORY.constructType(com.nutanix.dp1.pri.prism.v4.management.ClusterLocation.class);
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE12002 = TYPE_FACTORY.constructType(com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation.class);
      ...
      private com.nutanix.dp1.pri.prism.v4.management.ClusterLocation oneOfType12001;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      private com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation oneOfType12002;
      ...
      public void setValue(Object value) {
        ...
        if (value instanceof com.nutanix.dp1.pri.prism.v4.management.ClusterLocation) {
          this.oneOfType12001 = (com.nutanix.dp1.pri.prism.v4.management.ClusterLocation) value;
          this.discriminator = this.oneOfType12001.get$objectType();
          this.$objectType = this.oneOfType12001.get$objectType();
          return;
        }
        if (value instanceof com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation) {
          this.oneOfType12002 = (com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation) value;
     ...
     * <ul>
     * <li>com.nutanix.dp1.pri.prism.v4.management.ClusterLocation</li>
     * <li>com.nutanix.dp1.pri.prism.v4.management.ObjectStoreLocation</li>
     * </ul>
     * @return Object
     */
