...
public class ExternalizableAbstractModel extends com.nutanix.dp1.pri.common.v1.config.TenantAwareModel implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public ExternalizableAbstractModel(String tenantId, String extId, java.util.List<com.nutanix.dp1.pri.common.v1.response.ApiLink> links) {
    super(tenantId);
    this.setExtId(extId);
    this.setLinks(links);
  }
  ...
  protected String initialize$fv() {
    ...
    private List<com.nutanix.dp1.pri.common.v1.response.ApiLink> links = null;
  
    /**
     * A HATEOAS style link for the response.  Each link contains a user-friendly name identifying the link and an address for retrieving the particular resource.

     */
    public void setLinks(List<com.nutanix.dp1.pri.common.v1.response.ApiLink> links) {
      if (this.links == null) {
        this.links = links;
      }
      else {
