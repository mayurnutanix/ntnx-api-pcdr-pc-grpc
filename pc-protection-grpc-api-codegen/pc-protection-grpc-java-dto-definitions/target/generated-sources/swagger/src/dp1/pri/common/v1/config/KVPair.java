...
@Data
@JsonFilter("dp1.pri.common.v1.config.KVPairFilter")
    ...
    */
    ...
    public static class OneOfValueWrapper {
      ...
      public OneOfValueWrapper(java.util.List data) {
        ...
        if(dp1.pri.common.v1.config.MapOfStringWrapper.class.equals(cls)) {
          this.oneOfType1007 = (java.util.List<dp1.pri.common.v1.config.MapOfStringWrapper>) data;
      ...
      private static class OneOfValueWrapperJsonDeserializer extends dp1.pri.deserializers.PriOneOfDeserializer<OneOfValueWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE1007 = TYPE_FACTORY.constructCollectionType(java.util.List.class, dp1.pri.common.v1.config.MapOfStringWrapper.class);
      ...
      private java.util.List<dp1.pri.common.v1.config.MapOfStringWrapper> oneOfType1007;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      @javax.validation.constraints.Size(min = 0, max = 100)
      ...
      private boolean setOneOfType1007(Object value) {
        Class valueClass = dp1.pri.common.v1.config.MapOfStringWrapper.class;
        if(java.util.List.class.isAssignableFrom(value.getClass())) {
          // list try to match types if list is not empty.
          if (((java.util.List) value).size() > 0) { 
            if (valueClass.equals(((java.util.List) value).get(0).getClass())) {
              this.discriminator = "List<common.v1.config.MapOfStringWrapper>";
              this.$objectType = "List<common.v1.config.MapOfStringWrapper>";
              this.oneOfType1007 = (java.util.List<dp1.pri.common.v1.config.MapOfStringWrapper>) value;
              return true;
            }
            return false;
          } else {
            this.discriminator = "EMPTY_LIST";
            this.$objectType = "EMPTY_LIST";
            this.oneOfType1007 = (List<dp1.pri.common.v1.config.MapOfStringWrapper>) value;
            return true;
          }
        }
        return false;
