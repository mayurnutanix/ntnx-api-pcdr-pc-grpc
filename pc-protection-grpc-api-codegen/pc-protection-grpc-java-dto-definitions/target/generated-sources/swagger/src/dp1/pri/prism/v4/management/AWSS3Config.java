...
@Data
@JsonFilter("dp1.pri.prism.v4.management.AWSS3ConfigFilter")
@lombok.extern.slf4j.Slf4j
public class AWSS3Config extends dp1.pri.prism.v4.management.S3Config implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  protected String initialize$fv() {
    ...
    public static class OneOfCredentialsWrapper {
      ...
      public OneOfCredentialsWrapper(dp1.pri.prism.v4.management.AccessKeyCredentials data) {
      ...
      private static class OneOfCredentialsWrapperJsonDeserializer extends dp1.pri.deserializers.PriOneOfDeserializer<OneOfCredentialsWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE12001 = TYPE_FACTORY.constructType(dp1.pri.prism.v4.management.AccessKeyCredentials.class);
      ...
      private dp1.pri.prism.v4.management.AccessKeyCredentials oneOfType12001;
      ...
      public void setValue(Object value) {
        ...
        if (value instanceof dp1.pri.prism.v4.management.AccessKeyCredentials) {
          this.oneOfType12001 = (dp1.pri.prism.v4.management.AccessKeyCredentials) value;
     ...
     * <ul>
     * <li>dp1.pri.prism.v4.management.AccessKeyCredentials</li>
     * </ul>
     * @return Object
     */
