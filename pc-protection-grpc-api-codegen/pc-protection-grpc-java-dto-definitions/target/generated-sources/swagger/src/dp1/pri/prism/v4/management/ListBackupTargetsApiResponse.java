...
@Data
@JsonFilter("dp1.pri.prism.v4.management.ListBackupTargetsApiResponseFilter")
...
public class ListBackupTargetsApiResponse implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public ListBackupTargetsApiResponse(dp1.pri.common.v1.response.ApiResponseMetadata metadata, Object data) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
    ...
    */
    ...
    public static class OneOfDataWrapper {
      ...
      public OneOfDataWrapper(java.util.List data) {
        ...
        if(dp1.pri.prism.v4.management.BackupTarget.class.equals(cls)) {
          this.oneOfType31007 = (java.util.List<dp1.pri.prism.v4.management.BackupTarget>) data;
      ...
      private static class OneOfDataWrapperJsonDeserializer extends dp1.pri.deserializers.PriOneOfDeserializer<OneOfDataWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE31007 = TYPE_FACTORY.constructCollectionType(java.util.List.class, dp1.pri.prism.v4.management.BackupTarget.class);
      ...
      private java.util.List<dp1.pri.prism.v4.management.BackupTarget> oneOfType31007;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      ...
      private boolean setOneOfType31007(Object value) {
        Class valueClass = dp1.pri.prism.v4.management.BackupTarget.class;
        if(java.util.List.class.isAssignableFrom(value.getClass())) {
          ...
          if (((java.util.List) value).size() > 0) { 
            if (valueClass.equals(((java.util.List) value).get(0).getClass())) {
              this.discriminator = "List<prism.v4.management.BackupTarget>";
              this.$objectType = "List<prism.v4.management.BackupTarget>";
              this.oneOfType31007 = (java.util.List<dp1.pri.prism.v4.management.BackupTarget>) value;
              return true;
            }
            return false;
          } else {
            this.discriminator = "EMPTY_LIST";
            this.$objectType = "EMPTY_LIST";
            this.oneOfType31007 = (List<dp1.pri.prism.v4.management.BackupTarget>) value;
            return true;
          }
        }
        return false;
