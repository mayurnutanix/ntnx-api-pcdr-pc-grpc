...
@Data
@JsonFilter("dp1.pri.prism.v4.management.GetBackupTargetApiResponseFilter")
...
public class GetBackupTargetApiResponse implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public GetBackupTargetApiResponse(dp1.pri.common.v1.response.ApiResponseMetadata metadata, Object data) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
  ...
  private void setUndeserializedFields(String name, Object value) {
    ...
    */
    ...
    public static class OneOfDataWrapper {
      ...
      public OneOfDataWrapper(dp1.pri.prism.v4.management.BackupTarget data) {
      ...
      private static class OneOfDataWrapperJsonDeserializer extends dp1.pri.deserializers.PriOneOfDeserializer<OneOfDataWrapper>  {
        ...
        private static final com.fasterxml.jackson.databind.JavaType ONE_OF_TYPE31007 = TYPE_FACTORY.constructType(dp1.pri.prism.v4.management.BackupTarget.class);
      ...
      private dp1.pri.prism.v4.management.BackupTarget oneOfType31007;
      @com.fasterxml.jackson.annotation.JsonIgnore
      @lombok.Getter(lombok.AccessLevel.NONE)
      @lombok.Setter(lombok.AccessLevel.NONE)
      ...
      public void setValue(Object value) {
        ...
        if (value instanceof dp1.pri.prism.v4.management.BackupTarget) {
          this.oneOfType31007 = (dp1.pri.prism.v4.management.BackupTarget) value;
     ...
     * <ul>
     * <li>dp1.pri.prism.v4.management.BackupTarget</li>
