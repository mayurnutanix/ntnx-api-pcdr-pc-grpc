...
@Data
@JsonFilter("dp1.pri.common.v1.response.ApiResponseMetadataFilter")
...
public class ApiResponseMetadata implements java.io.Serializable, PriObjectTypeTypedObject {
  ...
  public ApiResponseMetadata(java.util.List<dp1.pri.common.v1.config.Flag> flags, java.util.List<dp1.pri.common.v1.response.ApiLink> links, Integer totalAvailableResults, java.util.List<dp1.pri.common.v1.config.Message> messages, java.util.List<dp1.pri.common.v1.config.KVPair> extraInfo) {
    this.$objectType = this.initialize$objectType();
    this.$reserved = new java.util.LinkedHashMap<>();
    this.$reserved.put("$fv", this.initialize$fv());
    this.$unknownFields = new java.util.LinkedHashMap<>();
  ...
  private void setUndeserializedFields(String name, Object value) {
    ...
    @Data
    public static class ApiResponseMetadataFlags extends dp1.pri.models.PriAbstractBoundedMap<java.lang.Boolean> {
    ...
    public java.util.List<dp1.pri.common.v1.config.Flag> getFlags() {
      if (this.flags == null) {
        this.flags = new ApiResponseMetadataFlags();
      }
      java.util.List<dp1.pri.common.v1.config.Flag> retVal = new java.util.LinkedList<>();
      this.flags.getKeys().forEach(key -> {
        java.lang.Boolean value = this.flags.get(key);
        dp1.pri.common.v1.config.Flag item = dp1.pri.common.v1.config.Flag.FlagBuilder().name(key).value(value).build();
        retVal.add(item);
      });
      return retVal;
    }
    
    public void setFlags(java.util.List<dp1.pri.common.v1.config.Flag> flags) {
      if (this.flags == null) {
        this.flags = new ApiResponseMetadataFlags();
      }
      if (flags != null) {
    ...
    */
    ...
    @JsonProperty("links")
    public List<dp1.pri.common.v1.response.ApiLink> links = null;
    ...
    */
    ...
    public List<dp1.pri.common.v1.config.Message> messages = null;
    ...
    */
    ...
    public List<dp1.pri.common.v1.config.KVPair> extraInfo = null;
